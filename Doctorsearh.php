...
$serverusername = "localhost"; // Your database host
$userusername = "root"; // Your database username
$password = ""; // Your database password
$database = "mobile"; // Your database name

// Create connection
$conn = new mysqli($serverusername, $userusername, $password, $database);
...
if (isset($request_data['username'])) {
    ...
    // Query to search for patient based on username
    $sql = "SELECT * FROM patsignup WHERE `username` LIKE ?"; // Assuming 'username' is the column name for patient usernames
